...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-primary p-3">
    <div class="container">
        <a class="navbar-brand mb-0" style="font-size: 30px; padding-left: 20px" href="#">Admin FutsalCorner</a>
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item <?php if ($active == 2) echo 'active'?>">
                    <a class="nav-link" href="<?php echo base_url()?>booking">Account</a>
                </li>
                <li class="nav-item <?php if ($active == 3) echo 'active'?>">
                    <a class="nav-link" href="<?php echo base_url()?>booking">Booking</a>
                </li>
                <li class="nav-item dropdown row" <?php if ($active == 4) echo 'active'?>>
